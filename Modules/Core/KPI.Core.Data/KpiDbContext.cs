...
using KPI.Infrastructure;//domain
using KPI.Core.Domain;

namespace KPI.Core.Data
{
    public class KpiDbContext : DbContext //IdentityDbContext<User, Role, long, IdentityUserClaim<long>, UserRole, IdentityUserLogin<long>, IdentityRoleClaim<long>, IdentityUserToken<long>>
    {
        public KpiDbContext(DbContextOptions options) : base(options)
        {
        }
